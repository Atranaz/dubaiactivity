...
<html>
  <head>
    ...
    <!-- Bootstrap 3.3.4 -->
    <link href="<?php echo base_url(); ?>assets/cms/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />    
    <!-- FontAwesome 4.3.0 -->
    <link href="<?php echo base_url(); ?>assets/cms/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
    <!-- Ionicons 2.0.0 -->
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo base_url(); ?>/cms" class="logo">
          ...
          <span class="logo-mini"><b>UA</b>E</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b></b>UAE ACTIVITY</span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="<?php echo base_url(); ?>cms/loadChangePass" class="btn btn-default btn-flat"><i class="fa fa-key"></i> Change Password</a>
                    </div>
                    <div class="pull-right">
                      <a href="<?php echo base_url(); ?>cms/logout" class="btn btn-default btn-flat"><i class="fa fa-sign-out"></i> Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="<?php echo base_url(); ?>cms/closed_request" >
           ...
           <!--  <li class="treeview">
            ...
            ?>
            <li class="treeview">
              <a href="<?php echo base_url(); ?>cms/userListing">
                <i class="fa fa-users"></i>
                <span>Users</span>
              </a>
            </li>
